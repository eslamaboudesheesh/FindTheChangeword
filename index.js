...
var result = document.getElementsByClassName('resultt')[0];
var result2 =  document.getElementsByClassName('resultt')[1]; 
var diffType = "diffWords";
//diffChars , diffWords  ,diffLines , diffCss
function check(){
    var oldStr = a.value;
    var newStr = b.innerText;
    var changes = JsDiff[diffType](oldStr, newStr);
    console.log(changes)
    result.innerHTML = JsDiff.convertChangesToXML(changes);
    result2.innerHTML= JsDiff.convertChangesToXML(changes);
    console.log(result);
}
...
$(document).ready(function(){
	...
	//You might want to do if check to see if localstorage set for theImage here
	     $('iframe').hide();       
$('.classhere').on("click",function(){

$('.old-area').hide();
$('.imagearea-2').hide();
$('.conatiner-2').hide();
        var ifrm = document.createElement("iframe");
        ifrm.setAttribute("src", localStorage.theImage );
        ifrm.style.width = "500px";
        ifrm.style.height = "580px";
